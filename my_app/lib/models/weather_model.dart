...
class WeatherModel {
  ...
  MaterialColor getThemeColor() {
    ...
    weatherStateName == 'Blizzard' ||  weatherStateName == 'Patchy snow possible'  ||  weatherStateName == 'Patchy sleet possible' || weatherStateName == 'Patchy freezing drizzle possible' || weatherStateName == 'Blowing snow' ||  weatherStateName == 'Partly cloudy') {
      return Colors.blue;
